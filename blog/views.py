...
# ################# Old ########################
def xxindex(request, tag_slug=None, cat_slug=None, arch_date=None,
            event_year=None):
...
def xxpost_page(request,
                post_slug, tag_slug=None, cat_slug=None, arch_date=None,
                event_year=None):

    # Note: A lot of redundant code in this function comparing with index()
    # Should change to class based view in future.
